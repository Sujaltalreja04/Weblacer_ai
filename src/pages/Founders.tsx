...
const founders = [
  {
    ...
    social: {
      linkedin: 'https://linkedin.com/in/sujaltalreja',
      github: 'https://github.com/sujaltalreja',
                    ...
                    <>
                      ...
                      <div className="flex flex-col items-start lg:items-end lg:text-right">
                        ...
                        <div className={`flex items-center gap-4 mt-6 ${founder.name === 'Hitanshu Patel' ? 'justify-end' : 'justify-start'}`}>
                          {((founder.name as string) === 'Sujal Talreja'
                            ? [
                                { year: '2020', label: 'Started Web Dev' },
                                { year: '2021', label: 'Co-founded Weblancer' },
                                { year: '2022', label: 'National Finalist' },
                                { year: '2023', label: 'CMO & Growth' },
                              ]
                            : [
                                { year: '2019', label: 'Python Enthusiast' },
                                { year: '2021', label: 'Co-founded Weblancer' },
                                { year: '2022', label: 'AI Lead' },
                                { year: '2023', label: 'CTO & Backend' },
                              ]
                          ).map((milestone, i) => (
                            <motion.div
                              key={milestone.year}
                            ...
                            >
                              <span className="w-3 h-3 rounded-full bg-[#B5FF6D] mb-1 animate-pulse shadow-lg" />
                              <span className="text-xs text-[#B5FF6D] font-bold">{milestone.year}</span>
